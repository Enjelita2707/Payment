<?php  
	...
	$aksi = new oop($koneksi); // untuk memanggil class di library dengan koneksi database
				...
				<div class="col-md-6">
					<div class="panel panel-primary">
						...
						<div class="panel-footer">
							<center>
								<strong>&copy;2020 - Defri (<a href="https://www.youtube.com/channel/UCS0McpxsS8d0XC2AmJNQdpQ?view_as=subscriber/">Rumah Koding</a>)
							</center>
						</div>
						<!-- end footer -->
					</div>
