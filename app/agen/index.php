<?php  
	...
	include '../library/fungsi.php'; // untuk memasukkan library
	...
	// tampung username & password agar dibaca sebagai string bukan syntax
	$username = mysqli_real_escape_string($koneksi, $_POST['username'] ?? '');
	$password = mysqli_real_escape_string($koneksi, $_POST['password'] ?? '');

	// jika session username agen tidak kosong, pindah ke halaman utama
	if (!empty($_SESSION['username_agen'])) {
		$aksi->redirect("hal_utama.php?menu=home");
	}

	// jika tombol login ditekan, jalankan fungsi login dari library
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						...
						<div class="panel-footer">
							<center>&copy;<?php echo date("Y"); ?> - Wawan Santoso</center>
						</div>
						<!-- end footer -->
					</div>
				</div>
