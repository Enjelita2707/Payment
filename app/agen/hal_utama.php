...
<body>
					...
					<ul class="nav navbar-nav navbar-right" style="margin-right: 50px;">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" id="akun">
								...
								<strong><?php echo isset($_SESSION['nama_petugas']) ? $_SESSION['nama_petugas'] : 'Nama Petugas'; ?></strong>&nbsp;
								<span class="caret"></span>
							</a>
	...
	<footer class="container-fluid bg-4 text-center" style="background-color: #fffefe">
		<p>
			<strong>Copyright&nbsp;&copy;&nbsp;2020 <a target="_blank" href="https://www.youtube.com/channel/UCS0McpxsS8d0XC2AmJNQdpQ?view_as=subscriber/">Rumah Koding</a>.</strong>&nbsp;
		</p>
	</footer>
